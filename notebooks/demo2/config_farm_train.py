...
class Config:
    def __init__(self, project_name, experiment_type="RELEVANCE", root=""):
        self.root = str(pathlib.Path(__file__).resolve().parent.parent.parent) 
...
class FileConfig(Config):
    ...
    def __init__(self,project_name):
        ...
        self.curated_data = os.path.join(self.data_dir, "curation", "esg_TEXT_dataset.csv")
        self.curated_table_data = os.path.join(self.data_dir, "curation", "esg_TABLE_dataset.csv")
        self.extracted_tables_dir = os.path.join(self.data_dir, "extraction")
        self.dev_split = .2
        self.train_filename = os.path.join(self.data_dir, f"kpi_train_split.csv")
        self.dev_filename = os.path.join(self.data_dir, f"kpi_val_split.csv")
        self.test_filename = None
        self.saved_models_dir = os.path.join(self.root, "models/", self.experiment_type, self.experiment_name,
                                             self.data_type)
...
class ProcessorConfig(Config):
    ...
    def __init__(self,project_name):
        ...
        self.load_dir = os.path.join(self.root, "models", self.data_type, "relevance_roberta")
...
class ModelConfig(Config):
    ...
    def __init__(self,project_name):
        ...
        self.load_dir = os.path.join(self.root, "models", "NQ",
...
class InferConfig(Config):
    ...
    def __init__(self, project_name):
        ...
        self.load_dir = {"Table": os.path.join(self.root, "models", self.experiment_type, self.experiment_name, "Table"),
                         "Text": os.path.join(self.root, "models", self.experiment_type, self.experiment_name, "Text")}

        # Use the following for the pre-trained models inside Docker
        # oneqbit_checkpoint_dir = os.path.join(self.root, "model_pipeline", "models", "1QBit_Pretrained_ESG")
        ...
        self.extracted_dir = os.path.join(self.root, "data", "extraction", self.experiment_name)
        self.result_dir = {
            "Table": os.path.join(self.root, "data", "infer", self.experiment_type, self.experiment_name, "Table"),
            "Text": os.path.join(self.root, "data", "infer", self.experiment_type, self.experiment_name, "Text")}
        self.kpi_questions = []
