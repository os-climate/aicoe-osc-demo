"""BaseKPIInferenceCurator class def."""
...
class BaseKPIInferenceCurator(ABC):
    """Base class for KPI inference data curation."""
    ...
    def find_answer_start(answer, par):
        """
        Find the start indices of answer.
        ...
        """
        answer = "".join(["\." if c == "." else c for c in answer])  # noqa: W605
