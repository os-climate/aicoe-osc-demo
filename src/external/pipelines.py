...
class TokenClassificationArgumentHandler(ArgumentHandler):
    """TokenClassificationArgumentHandler class.
...
class QuestionAnsweringArgumentHandler(ArgumentHandler):
    """QuestionAnsweringArgumentHandler class.
...
class TextClassificationPipeline(Pipeline):
    """TextClassificationPipeline class.
    ...
    def __init__(self, return_all_scores: bool = False, **kwargs):
        """Initialize TextClassificationPipeline class."""
...
class TokenClassificationPipeline(Pipeline):
    """TokenClassificationPipeline class.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize TokenClassificationPipeline class."""
        super().__init__(
...
class QuestionAnsweringPipeline(Pipeline):
    """QuestionAnsweringPipeline class.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize QuestionAnsweringPipeline class."""
        super().__init__(
            model=model,
            tokenizer=tokenizer,
    ...
    def span_to_answer(
        ...
        """Map token indexes to actual word in the initial context.
...
def overwrite_transformer_onnx_model_inputs(
    ...
    """Override an ONNX model's inputs to have the given batch size and sequence lengths.
